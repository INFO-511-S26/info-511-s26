...
::: callout-important
Introduce yourself via the #general channel in the course Discord (see D2L announcement)
:::
...
-   Links to GitHub, D2L, Codespaces (can run Jupyter), etc.
...
No specific points allocated to participation, but participation via Discord, particularly Discussions, will be recorded periodically throughout the semester, and this information will be used as “extra credit” if you’re in between two grades and a minor bump would help.
...
-   Posted on D2L (Announcements tool) but [primarily sent via Discord]{.underline}, be sure to check both regularly
